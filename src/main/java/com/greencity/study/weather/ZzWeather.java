 ...
 * @author AndyFung
 * @version 1.0
 * @date 2020/11/24/024 14:32
 */
public class ZzWeather {
    ...
    public static Map<String, Object> getTodayWeather1(String cityId)throws IOException,NullPointerException {
        ...
        //String url1="https://devapi.qweather.com/v7/weather/now?location="+cityId+"&key=dc728e005b4b412e9dab090a0a11db30";
